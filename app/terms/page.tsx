        ...
        <div className="prose prose-neutral max-w-none space-y-8 text-muted-foreground">
          <section>
            ...
            <p className="leading-relaxed">
              ...
              legal agreement between you and PorchLight Home Offers LLC doing business as WholesalerPhone ("Company," "we," "us," or "our").
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              design) are owned by PorchLight Home Offers LLC and protected by copyright, trademark, and other intellectual
              property laws.
            </p>
            <p className="leading-relaxed mt-4">
          ...
          <section>
            ...
            <p className="leading-relaxed mt-4">
              <strong>Limitation of Liability:</strong> To the maximum extent permitted by law, PorchLight Home Offers LLC
          ...
          <section>
            ...
            <p className="leading-relaxed">
              You agree to indemnify, defend, and hold harmless PorchLight Home Offers LLC, its officers, directors, employees,
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              PorchLight Home Offers LLC regarding the Service.
            </p>
          </section>
